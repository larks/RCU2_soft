...
int dram_init (void)
{
	...
	volatile struct ddr_regs	*ddr = (void *)0x40020800;
	u16				val;
	...
	ddr->ddrc.DRAM_MR_TIMING_PARAM_CR =		0x64;
	...
	ddr->ddrc.DRAM_BANK_ACT_TIMING_CR =		0x1937;
	...
	ddr->ddrc.DYN_SOFT_RESET_CR2 =		        0x1; 
	...
	ddr->phy.DATA_SLICE_IN_USE_CR =			0x3;
