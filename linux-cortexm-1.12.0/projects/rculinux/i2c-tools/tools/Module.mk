...
TOOLS_TARGETS	:= i2cdetect i2cdump i2cset i2cget ttcrx_reg i2csfp_reg
...
$(TOOLS_DIR)/ttcrx_reg: $(TOOLS_DIR)/ttcrx_reg.o $(TOOLS_DIR)/i2cbusses.o $(TOOLS_DIR)/util.o
	$(CC) $(LDFLAGS) -o $@ $^


$(TOOLS_DIR)/i2csfp_reg: $(TOOLS_DIR)/i2csfp_reg.o $(TOOLS_DIR)/i2cbusses.o $(TOOLS_DIR)/util.o
	$(CC) $(LDFLAGS) -o $@ $^
...
$(TOOLS_DIR)/ttcrx_reg.o: $(TOOLS_DIR)/ttcrx_reg.c $(TOOLS_DIR)/i2cbusses.h $(TOOLS_DIR)/util.h version.h $(INCLUDE_DIR)/linux/i2c-dev.h
	$(CC) $(CFLAGS) $(TOOLS_CFLAGS)  --param max-inline-insns-single=20  -c $< -o $@

$(TOOLS_DIR)/i2csfp_reg.o: $(TOOLS_DIR)/i2csfp_reg.c $(TOOLS_DIR)/i2cbusses.h $(TOOLS_DIR)/util.h version.h $(INCLUDE_DIR)/linux/i2c-dev.h
	$(CC) $(CFLAGS) $(TOOLS_CFLAGS)  --param max-inline-insns-single=20  -c $< -o $@
