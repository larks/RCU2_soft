...
{
  /*
  printk("reset the value in HARDFAULT\n");
  *((volatile unsigned int *)0xA0358020) = 0xA0358000;
  */
...
{
  /*
  printk("reset the value in USAGEFAULT");
  *((unsigned int *)0xA0358020) = 0xA0358000;
  printk("0x%x\n", *(unsigned int*)0xA0358020);
  regs->ARM_r5 = 0xA0358020;
  show_regs(regs);
  printk("end of usagefault\n");
  */
