...
extern void exec_ComBlk_IRQHandler(void);
extern void exec_ECC_Error_IRQHandler(void);
//extern void reset_cpu(ulong addr);
extern void i2c_a2f_irq(void);
...
unsigned int vectors[] __attribute__((section(".vectors"))) = {
	...
	[35] = (unsigned int)&exec_ComBlk_IRQHandler
	//[20] =  (unsigned int)&i2c_a2f_irq
	//[23] =  (unsigned int)&I2C1_IRQHandler
	//[45] = (unsigned int)&exec_ECC_Error_IRQHandler
	/*
	[2 ... 34]	= (unsigned int)&default_isr, 
	[35] = (unsigned int)&exec_ComBlk_IRQHandler,
	[36 ... 44]	= (unsigned int)&default_isr, 
	[45] = (unsigned int)&exec_ECC_Error_IRQHandler,
	[46 ... 165]	= (unsigned int)&default_isr
	*/
};
...
const cfg_addr_value_pair_t g_m2s_ddrc_0_config[4] =
{
  { (int*)( 0x40020000 + 0x018 ), 0x10F }, 
  { (int*)( 0x40020000 + 0x0e8 ), 0x30 },
  { (int*)( 0x40020000 + 0x0ec ), 0x80 },
  { (int*)( 0x40020000 + 0x13c ), 0x80 }
};
